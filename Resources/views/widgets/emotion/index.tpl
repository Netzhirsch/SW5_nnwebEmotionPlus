    ...
    {foreach $sEmotions as $emotion}
        ...
        {block name="widgets/emotion/index/container"}
            ...
            {block name="widgets/emotion/index/emotion"}
                <section id="{$emotion.attribute.css_id}" class="emotion--container emotion--column-{$emotionCols} emotion--mode-{$emotionMode} emotion--{$emotion@index} {$emotion.attribute.css_class}"
                         data-emotion="true"
                    ...
                    {if $emotion.elements.0}
                        {foreach $emotion.elements as $element}
                            {block name="widgets/emotion/index/element"}
                                ...
                                {strip}
                                <div class="{$itemCls}" style="{if !$emotion.attribute.auto_height}{$itemStyle}{/if}">
                        ...
                        {block name="widgets/emotion/index/sizer"}
                        	{if !$emotion.attribute.auto_height}
